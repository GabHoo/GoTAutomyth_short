...
def textGeneration_Event1_1(story):
    ...
    {  
    ns2:Story ns1:hasActor ?Hero.

    ?Hero  rdfs:label ?HeroName.
    ns2:Story  ns2:hasOccupation ?Job.
    ?Job   rdfs:label ?HeroJob.
    ns2:Story  ns2:hasTitle ?Title.
    ?Title rdfs:label ?TitleLabel.
    ns2:Story  ns2:hasHouse ?Family.
...
def textGeneration_Event2_1(story):
    ...
    ns2:Story  ns1:hasActor ?Hero.
    ?Hero  rdfs:label ?HeroName.
    ns2:Story  ns2:ThreatenedElement ?el.
    ?el   rdfs:label ?ElementLabel.
    ns2:Story  ns2:villain ?villain.
    ?villain rdfs:label ?VillainLabel.

    ns2:Story  ns1:hasTime ?Time2.
    ?Time2 rdfs:label ?TimeLabel2.
    ns2:Story  ns1:hasPlace ?Loc2.
