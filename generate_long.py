...
training_args = transformers.Seq2SeqTrainingArguments(
    ...
    generation_max_length = 900, #max number of tokens per generation 
...
trainer.save_model("LONG_model" + experiment_name + how+ "new2" )

### let's have a look at the predictions

preds, labels, metrics = trainer.predict(tokenize_data['test'], num_beams=5, min_length=700, max_length=800, no_repeat_ngram_size=2, early_stopping=True)
...
outfile = open("new2"+how + '_long_output_metrics.txt', "a", encoding='utf-8')
...
outfile1 = open("new2"+how + '_long_text_stories.json', "a", encoding='utf-8')
