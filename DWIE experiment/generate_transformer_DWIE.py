...
def main(argv, arc):
    ...
    if arc!=3:
        print(" ARGUMENT USAGE IS WRONG, RUN FILE LIKE: longformer_newparams.py experiment linearizedGraph")
        exit()
    ...
    tokenize_data = dataset.map(process_data_to_model_inputs, batched = True, remove_columns=['story','Instances Knowledge Graph'])
    #print(tokenize_data)
